<!--agt_dataagt_v1.php satu-->
<!--connect dan panggil to db dua-->
<!--tampilkan tiga-->
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
			...
			<div class="form-group" >
			  ...
			  <input type="text" class="form-control" autocomplete="false" id="nama" placeholder="Ketik Nama" name="Nama_Anggota2" 
    ...
    <div class="col-sm-6"> 
      <div class="panel panel-primary">
		...
		<div class="form-group" >
		  ...
		  <input type="varchar" class="form-control" id="KodeAgt5" name="Kode_Anggota5" 
		  value='<?php echo $row1['Kode_Anggota'];?>'>
		</div>	
		<br><br>
		<!--<button type="submit" class="btn btn-default">Submit</button>-->
		<button type="submit" class="btn btn-primary disabled btn-block" >Print</button>

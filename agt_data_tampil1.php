    ...
    <div class="col-sm-6">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
			<form method="post">
			<!--<form method="post" action="insertagt.php">-->
			<?php include 'agt_data.php'; ?>
			<div class="form-group" >
			  <label for="Nama_Anggota">Nama :</label>
			  <input type="text" class="form-control" id="nama" placeholder="Ketik Nama" name="Nama_Anggota1" 
			  value=<?php echo $row1['Nama_Anggota'];?> disabled="disabled">
			</div>
			<div class="form-group">
			  <label for="JK">Pilih Jenis Kelamin:</label>
			  <select class="form-control" id="JK" name="Jenis_Kelamin1" type="text" disabled="disabled">
			...
			<div class="form-group">
			  ...
			  <input type="text" class="form-control" id="TL" placeholder="Ketik Tempat Lahir" name="Tempat_Lahir1" value=<?php include 'agt_data.php'; echo $row1['Tempat_Lahir'];?>>
			</div>
			<div class="form-group">
			  <label for="Tanggal_Lahir">Tanggal Lahir :</label>
			  <input type="text" class="form-control" id="Tanggal_Lahir" placeholder="Ketik Tanggal Lahir" name="Tanggal_Lahir1" value=<?php echo $row1['Tanggal_Lahir'];?>>
			</div>
			<div class="form-group">
    ...
    <div class="col-sm-6"> 
      <div class="panel panel-primary">
		...
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" id="NamaBend" placeholder="Ketik Nama Bendahara" name="Bendahara_SKPD1" value=<?php echo $row1['Bendahara_SKPD'];?>>
		</div>
		<div class="form-group">
		  <label for="NoHP_BendSKPD">Nomor HP Bendahara :</label>
		  <input type="text" class="form-control" id="NHPBend" placeholder="Ketik No HP Bend" name="NoHP_BendSKPD1" value=<?php echo $row1['NoHP_BendSKPD'];?>>
		</div>
		<div class="form-group">
		  <label for="SW_Per_Bulan">Jumlah Simpanan Wajib :</label>
		  <input type="number" class="form-control" id="JSW" placeholder="Ketik Jumlah Simpanan Wajib" name="SW_Per_Bulan1" value=<?php echo $row1['SW_Per_Bulan'];?>>
		</div>
		<!--<div class="form-group">
		...
		<div class="form-group" >
		  ...
		  <input type="varchar" class="form-control" id="KodeAgt" placeholder="Ketik Kode Anggota" name="Kode_Anggota1" 
		  value=<?php echo $row1['Kode_Anggota'];?>>
		</div>	
		<br><br>
		<!--<button type="submit" class="btn btn-default">Submit</button>-->
		<button type="submit" class="btn btn-primary disabled btn-block">Save</button>
